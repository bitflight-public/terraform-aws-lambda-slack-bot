...
def lambda_handler(data, context):
    ...
    if "challenge" in data:
        ...
        response = client.put_parameter(Name=PARAMETER_PATH, Value=data["token"], Type="String", Overwrite=True)
        logger.info(data)
    ...
    if "bot_id" in slack_event:
        ...
        data = urllib.parse.urlencode((("token", BOT_TOKEN), ("channel", channel_id), ("text", reversed_text)))
